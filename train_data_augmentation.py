...
training_generator.set_pipeline([dataloader.random_resized_crop, dataloader.center_crop, dataloader.random_flip_left_right, dataloader.normalize, dataloader.permute_to_right_shape, dataloader.to_float])

training_generator = training_generator.flow_from_directory( os.path.join( root , "for_training" ) , class_mode = "categorical" , batch_size = args.sz_batch )
...
validation_generator.set_pipeline([dataloader.only_resize, dataloader.permute_to_right_shape, dataloader.to_float])

validation_generator = validation_generator.flow_from_directory( os.path.join( root , "for_evaluation" ) , class_mode = "categorical" , batch_size = args.val_sz_batch )
