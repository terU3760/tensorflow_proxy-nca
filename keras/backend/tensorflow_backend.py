...
def switch(condition, then_expression, else_expression):
    ...
    ##### the following line(s) were modified by Ngaiman Chow on 2019-10-18 according to but workaround: https://github.com/keras-team/keras/issues/3857
    ###x = tf.python.control_flow_ops.cond(tf.cast(condition, 'bool'),
    x = tf.cond(tf.cast(condition, 'bool'),
    ##### the above line(s) were modified by Ngaiman Chow on 2019-10-18 according to but workaround: https://github.com/keras-team/keras/issues/3857
...
def in_train_phase(x, alt):
    ...
    x = tf.cond(tf.cast(_LEARNING_PHASE, 'bool'),
    ##### the above line(s) were modified by Ngaiman Chow on 2019-10-18 according to but workaround: https://github.com/keras-team/keras/issues/3857
                                        lambda: x,
                                        lambda: alt)
